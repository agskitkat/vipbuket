...
(function($) {
    jQuery.fn.smartLazyLoad = function (sittings) {
        ...
        try {
            var opacityShow = sittings.opacityShow?true:false;
        } catch (e) {
            var opacityShow = false;
        }
        ...
        $().ready( function(e) {
            ...
            $.each(elements, function(k, v){
                if(opacityShow) {
                    $(v).addClass("img-opacity").css({"opacity":"0"});
                }
                checkLoad(top, v);
            });
...
function splashScreenView() {
    $(".splash-screen").removeClass("hide").addClass("visible");
}
