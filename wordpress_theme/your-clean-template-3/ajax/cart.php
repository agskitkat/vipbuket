								...
								<div class="item__quantity-block">
									<div class="quantity-block__control">
										...
										<div class="price-by-one">
											<?=$item['price']?> руб. /<span class="measure">шт.</span>
										</div>
									</div>
								</div>
            ...
            <div class="cart__summary"> 
                <div class="summary__border">
                    <div class="flex-row">
                        ...
                        <span id="sum-old-price"><?=$old_sum?> ₽</span>
                    </div>
                    <div class="flex-row">
                        <span>Скидка на товары</span>
                        <span id="sum-sale" class="red"><?=$sale_sum?> ₽</span>
                    </div>
                    
                    <div class="summary__line"></div>
                    <div class="flex-row flex-row__end">
                        <span>Итого</span>
                        <span id="sum-price" class="price"><?=$sum?> ₽</span>
                    </div>
                </div>
