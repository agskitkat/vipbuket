...
$(function(){$(".good-wrap .good .mobile-expend-block").click(function(s){console.log("click",this.isOpen),this.isOpen?($(this).find(".expend-text").addClass("hide").removeClass("show"),$(this).find(".expend-fade").addClass("show").removeClass("hide"),this.isOpen=!1):($(this).find(".expend-text").addClass("show").removeClass("hide"),$(this).find(".expend-fade").addClass("hide").removeClass("show"),this.isOpen=!0)})});
...
$(function(){$("img:not(.just)").smartLazyLoad({offsetLoad:100,opacityShow:!0}),$(".slider").slick(),$(".good-wrap .about span").click(function(o){o.preventDefault(),o.stopPropagation(),$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open");var e=$(this).closest(".about").find(".expend"),i=$(this).closest(".good-wrap");if(e.is(".open"))e.removeClass("open"),i.removeClass("open");else{e.addClass("open");var t=e.outerHeight();i.css({"margin-bottom":-1*t+"px"}),i.addClass("open")}}),$(".good-wrap.open").click(function(o){o.stopPropagation()}),$("body").click(function(o){$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open")}),new SimpleBar($(".js-target-simplebar")[0]),$(".to-cart").click(function(){console.log("Add to cart");var o=$(this).closest(".good"),e=$.trim(o.find(".name").html()),i=$.trim(o.find(".article").html()),t=o.find(".price").html(),a=o.find(".old-price"),s="";0<a.length&&(s=a.html());var n=o.find(".image img").attr("src");$(".form-order .name").html(e),$(".form-order .article-price .article").html(i),$(".form-order .article-price .old").html(s),$(".form-order .article-price .new").html(t),$(".form-order input.image").val(n),$("#imageView").removeClass("active").addClass("hide").hide(),$(".form-order").removeClass("hide").addClass("active"),$("body").addClass("overflow")}),$(".js-target-view-video").click(function(){console.log("Video view");var o=$(this).attr("data-video"),e="";o&&(e=-1!==o.indexOf("youtube")?'<iframe src="'+o+'">\n    Ваш браузер не поддерживает плавающие фреймы!\n </iframe>':'<video src="'+o+'" autoplay></video>',$(".modal-container.video").show().css({display:"flex"}).find(".modal-content").html(e))}),$(".modal-container").click(function(o){console.log("modal-container"),$(this).hide(),$("body").removeClass("overflow"),$(this).is(".video")&&$(this).find(".modal-content").html("")}),$(".modal-container .modal-content").click(function(o){o.stopPropagation()}),$(".good-category .content-grid .good-wrap .image").click(function(o){console.log("Grid image click");var e=$(this).closest(".good-wrap"),i=$.trim(e.find(".name").html()),t=$.trim(e.find(".article").html()),a=e.find(".price").html(),s=e.find(".old-price").html(),n=e.find(".sale").html(),l=e.find(".hit"),d=e.find(".content").html(),r=$(this).find("img"),c=$("#imageView");console.log(i,r.attr("src")),c.find(".js-name").html(i),c.find(".js-article").html(t),c.find(".js-old-price").html(s),c.find(".js-price").html(a),c.find(".js-content").html(d),n?c.find(".js-sale").show().html(n):c.find(".js-sale").hide(),l.length?c.find(".js-hit").show():c.find(".js-hit").hide(),c.find(".js-image").attr({src:r.attr("src")}).css({opacity:"1"}),window.innerWidth<768?($("#imageView").css({display:"flex"}),$("body").addClass("overflow")):($("#imageView-desctop").css({display:"flex"}),$("body").addClass("overflow"),$("#imageView-desctop").find(".image").attr({src:r.attr("src")}).css({opacity:"1"}))}),$(".modal-container").find(".close").click(function(){console.log("imageView"),$(this).closest(".modal-container").css({display:"none"}),$("body").removeClass("overflow")})});
$(function(){$(".js-event-click-view-menu").click(function(){window.location.hash="menu--open"}),$(".js-event-click-hide-menu").click(function(){window.location.hash=""}),$("#js-target-mobile-menu .parent-category > li ").click(function(e){var n=$(this).find(".child").attr("id");if(!n)return window.location.href=$(this).find("span").attr("href"),!1;window.location.hash="menu--"+n}),$("#js-target-mobile-menu .child .js-event-click-hide-sub-menu").click(function(e){e.stopPropagation(),window.location.hash="menu--level-close"}),$(window).bind("hashchange",function(){var e=location.hash.split("--");if(2===e.length){var n=e[1];if(console.log(n),"open"!==n&&"level-close"!==n||(console.log("OPEN"),$("#js-target-mobile-menu").addClass("open")),"level-close"===n||!n||"open"===n){var o=$(".parent-category .child.open");console.log(o),o.removeClass("open").delay(300).queue(function(){$(this).hide()})}if(n){var i=$("#"+n);i.addClass("open").show(),i.length&&$("#js-target-mobile-menu").addClass("open")}}n||$("#js-target-mobile-menu").removeClass("open").find(".open").removeClass("open")})});