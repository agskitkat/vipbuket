...
!function(e){jQuery.fn.smartLazyLoad=function(t){var a=this,i=window.innerHeight,c=window.innerWidth;try{var r=t.offsetLoad?t.offsetLoad:0}catch(t){r=0}try{var d=!!t.opacityShow}catch(t){d=!1}function n(t,a){var o=e(a).offset(),n=!!e(a).attr("data-loaded")&&e(a).attr("data-loaded");"false"===n&&(n=!1),o.top>t-r&&o.top<t+i+r&&!n&&function(t){var a=e(t).attr("data-src"),n=!1,o=e(t).attr("data-srcset");if(o){var i=o.split(",");if(i.length){e.each(i,function(t,a){var o=a.match(/\s?(.*)\s(\d*)w/);o&&o[2]<=c&&(n=o[1],o[2])})}}n=n||a;e(t).attr({src:n}).attr({"data-loaded":!0}),d&&e(t).bind("load",function(){e(this).css({opacity:"1"})})}(a)}e().ready(function(t){var o=e(document).scrollTop();e.each(a,function(t,a){d&&e(a).addClass("img-opacity").css({opacity:"0"}),n(o,a)}),e(window).resize(function(){var o=e(document).scrollTop();i=window.innerHeight,c=window.innerWidth,e.each(a,function(t,a){e(a).attr({"data-loaded":!1}),n(o,a)})}),e(window).scroll(function(t){var o=e(document).scrollTop();e.each(a,function(t,a){n(o,a)})})})}}(jQuery);
$(function(){$(".good-wrap .good .mobile-expend-block").each(function(e,d){$(d).find(".content").innerHeight()<=38&&($(d).find(".expend-fade").hide(),$(d).find(".expend-button").hide())}),$(".good-wrap .good .mobile-expend-block").click(function(e){console.log("click",this.isOpen),this.isOpen?($(this).find(".expend-text").addClass("hide").removeClass("show"),$(this).find(".expend-fade").addClass("show").removeClass("hide"),this.isOpen=!1):($(this).find(".expend-text").addClass("show").removeClass("hide"),$(this).find(".expend-fade").addClass("hide").removeClass("show"),this.isOpen=!0)})});
$(function(){$(".form-block .close, .form-order").click(function(e){e.stopPropagation(),$(this).closest(".form-order").addClass("hide").removeClass("active"),$("body").removeClass("overflow")}),$(".form-order .form-block").click(function(e){e.stopPropagation()});var m=$(".form-order");m.find("input#postcard").change(function(){var e=m.find(".order-options .inputs");$(this).prop("checked")?e.show():e.hide()});var c=!1,f="";m.find("#do_order").click(function(e){e.preventDefault(),e.stopPropagation();var r=$(this);if(!c){f=r.html(),r.html(r.attr("data-wait-text")),c=!0;var a=$(m).find(".form__form").serializeArray(),o="";$.each(a,function(e,r){console.log(r.name),"user_name"!==r.name||r.value||(o+="Заполните имя<br>"),"user_phone"!==r.name||r.value||(o+="Заполните телефон<br>"),"user_email"!==r.name||function(e){return/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(e)}(r.value)||(o+="Заполните Email<br>"),"user_date"!==r.name||r.value||(o+="Заполните дату<br>"),"user_addr"!==r.name||r.value||(o+="Заполните адрес<br>")});var i=$(m).find(".good"),n=i.find(".name").html(),t=i.find(".article").html(),s=i.find(".price .new").html(),l=i.find("input.image").val();if(console.log(a),""===o){var d={action:"order",data:a,item:{name:n,article:t,price:s,img:l}};$.post("/wp-admin/admin-ajax.php",d,function(e){c=!1,r.html(f),m.addClass("hide").removeClass("active"),$(".modal-container.order-complite").css({display:"flex"})})}else{$(this).closest(".form-order").find(".errors").html("<span>Проверьте правильность заполнения формы:</span><br>"+o),c=!1,r.html(f)}}})});
$(function(){if(-1!==window.location.hash.indexOf("item-")){var o=$(window.location.hash);$("body,html").animate({scrollTop:$(o).offset().top},200)}});
$(function(){$("img:not(.just)").smartLazyLoad({offsetLoad:100,opacityShow:!0}),$(".slider").slick(),$(".good-wrap .about span").click(function(i){i.preventDefault(),i.stopPropagation(),$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open");var e=$(this).closest(".about").find(".expend"),o=$(this).closest(".good-wrap");if(e.is(".open"))e.removeClass("open"),o.removeClass("open");else{e.addClass("open");var t=e.outerHeight();o.css({"margin-bottom":-1*t+"px"}),o.addClass("open")}}),$(".good-wrap.open").click(function(i){i.stopPropagation()}),$("body").click(function(i){$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open")}),new SimpleBar($(".js-target-simplebar")[0]),$(".to-cart").click(function(){!function(i){var e=$(i).closest(".good");$("#imageView").css({display:"none"});e=$(this).closest(".good");var o=$.trim(e.find(".name").html()),t=$.trim(e.find(".article").html()),n=e.find(".price").html(),a=e.find(".old-price"),d="";0<a.length&&(d=a.html());var l=e.find(".image img").attr("src");$(".form-order .name").html(o),$(".form-order .article-price .article").html(t),$(".form-order .article-price .old").html(d),$(".form-order .article-price .new").html(n),$(".form-order input.image").val(l),$(".form-order").removeClass("hide").addClass("active"),$("body").addClass("overflow")}(this)}),$(".js-target-view-video").click(function(){var i=$(this).attr("data-video"),e="";i&&(e=-1!==i.indexOf("youtube")?'<iframe src="'+i+'">\n    Ваш браузер не поддерживает плавающие фреймы!\n </iframe>':'<video src="'+i+'" autoplay></video>',$(".modal-container.video").show().css({display:"flex"}).find(".modal-content").html(e))}),$(".modal-container").click(function(i){$(this).hide(),$(this).is(".video")&&$(this).find(".modal-content").html("")}),$(".modal-container .modal-content").click(function(i){i.stopPropagation()}),$(".good-category .content-grid .good-wrap .image").click(function(i){if(window.innerWidth<768){var e=$(this).closest(".good"),o=$("#imageView"),t=$.trim(e.find(".name").html()),n=$.trim(e.find(".article").html()),a=e.find(".price").html(),d=e.find(".expend").html(),l=e.find(".old-price"),s=!!e.find(".hit")&&e.find(".hit").html(),r=!!e.find(".sale")&&e.find(".sale").html(),c="";0<l.length&&(c=l.html());var m=e.find(".image img").attr("src");o.find(".name").html(t),o.find(".name-line__name").html(t),o.find(".article").html(n),o.find(".article-line__article").html(n),o.find(".old-price").html(c),o.find(".article-line__old-price").html(c),o.find(".price").html(a),o.find(".name-line__price").html(a),o.find(".expend-text").html(d),s?o.find(".hit").html(s).show():o.find(".hit").hide(),r?o.find(".sale").html(r).show():o.find(".sale").hide(),o.css({display:"flex"}),o.find(".good-image").attr({src:m}).css({opacity:"1"})}else{o=$("#imageView-desctop"),m=$(this).find("img").attr("src");o.css({display:"flex"}),o.find(".image").attr({src:m}).css({opacity:"1"})}}),$("#imageView-desctop").find(".close").click(function(){$("#imageView-desctop").css({display:"none"})}),$("#imageView").find(".close").click(function(){$("#imageView").css({display:"none"})}),$("#imageView").find(".good-image").click(function(){$("#imageView").css({display:"none"})})});
$(function(){$(".js-event-click-view-menu").click(function(){window.location.hash="menu--open"}),$(".js-event-click-hide-menu").click(function(){window.location.hash=""}),$("#js-target-mobile-menu .parent-category > li ").click(function(e){var n=$(this).find(".child");if(console.log(n),n.length){var o=$(this).find(".child").attr("id");window.location.hash="menu--"+o}else window.location.href=$(this).find("> span").attr("href")}),$("#js-target-mobile-menu .child .js-event-click-hide-sub-menu").click(function(e){e.stopPropagation(),window.location.hash="menu--level-close"}),$(window).bind("hashchange",function(){var e=location.hash.split("--");if(2===e.length){var n=e[1];if(console.log(n),"open"!==n&&"level-close"!==n||(console.log("OPEN"),$("#js-target-mobile-menu").addClass("open")),"level-close"===n||!n||"open"===n){var o=$(".parent-category .child.open");console.log(o),o.removeClass("open").delay(300).queue(function(){$(this).hide()})}if(n){var i=$("#"+n);i.addClass("open").show(),i.length&&$("#js-target-mobile-menu").addClass("open")}}n||$("#js-target-mobile-menu").removeClass("open").find(".open").removeClass("open")})});