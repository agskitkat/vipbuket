...
$(function(){$("img:not(.just)").smartLazyLoad({offsetLoad:100,opacityShow:!0}),$(".slider").slick(),$(".good-wrap .about span").click(function(o){o.preventDefault(),o.stopPropagation(),$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open");var e=$(this).closest(".about").find(".expend"),t=$(this).closest(".good-wrap");if(e.is(".open"))e.removeClass("open"),t.removeClass("open");else{e.addClass("open");var i=e.outerHeight();t.css({"margin-bottom":-1*i+"px"}),t.addClass("open")}}),$(".good-wrap.open").click(function(o){o.stopPropagation()}),$("body").click(function(o){$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open")}),new SimpleBar($(".js-target-simplebar")[0]),$(".to-cart").click(function(){var o=$(this).closest(".good"),e=$.trim(o.find(".name").html()),t=$.trim(o.find(".article").html()),i=o.find(".price").html(),a=o.find(".old-price").html(),n=o.find(".image img").attr("src");$(".form-order .name").html(e),$(".form-order .article-price .article").html(t),$(".form-order .article-price .old").html(a),$(".form-order .article-price .new").html(i),$(".form-order input.image").val(n),$(".form-order").removeClass("hide").addClass("active")}),$(".js-target-view-video").click(function(){var o=$(this).attr("data-video"),e="";o&&(e=-1!==o.indexOf("youtube")?(console.log("Youtube "+o),'<iframe src="'+o+'">\n    Ваш браузер не поддерживает плавающие фреймы!\n </iframe>'):(console.log("Native "+o),'<video src="'+o+'" autoplay></video>'),$(".modal-container.video").show().css({display:"flex"}).find(".modal-content").html(e))}),$(".modal-container").click(function(o){$(this).hide(),$(this).is(".video")&&$(this).find(".modal-content").html("")}),$(".modal-container .modal-content").click(function(o){o.stopPropagation()})});
