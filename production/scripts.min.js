...
$(function(){$("img:not(.just)").smartLazyLoad({offsetLoad:100,opacityShow:!0}),$(".slider").slick(),$(".good-wrap .about span").click(function(o){o.preventDefault(),o.stopPropagation(),$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open");var e=$(this).closest(".about").find(".expend"),r=$(this).closest(".good-wrap");if(e.is(".open"))e.removeClass("open"),r.removeClass("open");else{e.addClass("open");var t=e.outerHeight();r.css({"margin-bottom":-1*t+"px"}),r.addClass("open")}}),$(".good-wrap.open").click(function(o){o.stopPropagation()}),$("body").click(function(o){$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open")}),$(".form-block .close, .form-order").click(function(o){o.stopPropagation(),$(this).closest(".form-order").addClass("hide").removeClass("active")}),$(".form-order .form-block").click(function(o){o.stopPropagation()}),$(".to-cart").click(function(){var o=$(this).closest(".good"),e=$.trim(o.find(".name").html()),r=$.trim(o.find(".article").html()),t=o.find(".price").html(),s=o.find(".old-price").html();$(".form-order .name").html(e),$(".form-order .article-price .article").html(r),$(".form-order .article-price .old").html(s),$(".form-order .article-price .new").html(t),$(".form-order").removeClass("hide").addClass("active")})});
