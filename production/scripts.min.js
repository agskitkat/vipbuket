...
$(function(){$("img:not(.just)").smartLazyLoad({offsetLoad:100,opacityShow:!0}),$(".slider").slick(),$(".good-wrap .about span").click(function(o){o.preventDefault(),o.stopPropagation(),$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open");var e=$(this).closest(".about").find(".expend"),i=$(this).closest(".good-wrap");if(e.is(".open"))e.removeClass("open"),i.removeClass("open");else{e.addClass("open");var t=e.outerHeight();i.css({"margin-bottom":-1*t+"px"}),i.addClass("open")}}),$(".good-wrap.open").click(function(o){o.stopPropagation()}),$("body").click(function(o){$(".good-wrap.open").css({"margin-bottom":""}).removeClass("open").find(".expend.open").removeClass("open")}),new SimpleBar($(".js-target-simplebar")[0]),$(".to-cart").click(function(){!function(o){var e=$(o).closest(".good"),i=$.trim(e.find(".name").html()),t=$.trim(e.find(".article").html()),a=e.find(".price").html(),n=e.find(".old-price"),r="";0<n.length&&(r=n.html());var s=e.find(".image img").attr("src");$(".form-order .name").html(i),$(".form-order .article-price .article").html(t),$(".form-order .article-price .old").html(r),$(".form-order .article-price .new").html(a),$(".form-order input.image").val(s),$(".form-order").removeClass("hide").addClass("active"),$("body").addClass("overflow")}(this)}),$(".js-target-view-video").click(function(){var o=$(this).attr("data-video"),e="";o&&(e=-1!==o.indexOf("youtube")?'<iframe src="'+o+'">\n    Ваш браузер не поддерживает плавающие фреймы!\n </iframe>':'<video src="'+o+'" autoplay></video>',$(".modal-container.video").show().css({display:"flex"}).find(".modal-content").html(e))}),$(".modal-container").click(function(o){$(this).hide(),$(this).is(".video")&&$(this).find(".modal-content").html("")}),$(".modal-container .modal-content").click(function(o){o.stopPropagation()}),$(".good-category .content-grid .good-wrap .image").click(function(o){var e=$(this).find("img");$("#imageView").css({display:"flex"}),console.log("#imageView call",e),$("#imageView").find(".image").attr({src:e.attr("src")}).css({opacity:"1"})}),$("#imageView").find(".close").click(function(){$("#imageView").css({display:"none"})})});
